...
* **Always start with the basic functionality**
...
* **Always perform a manual QA before writing the automated scripts**
...
* **Try to break down bigger functionalities into as many smaller functions as possible**
...
* **Always start writing scripts from the top**
  
  When writing the test scripts, always start from the top of the page.
  
* **Keep your scripts aligned in a way which makes it easier for the readers to read**
